        ...
        <div className="bg-gradient-to-r from-gray-800/50 to-gray-700/50 backdrop-blur-sm border-b border-gray-600/30 relative overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto px-4 py-12 md:py-20">
            <div className="text-center max-w-5xl mx-auto">
              ...
              {/* Top Companies Logos */}
              <div className="mb-6">
                <p className="text-gray-400 text-sm mb-4 font-medium">Students placed at top companies:</p>
                <div className="flex flex-wrap justify-center items-center gap-6 md:gap-8 opacity-90">
                  {/* Google */}
                  <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-lg border border-gray-700/30 hover:border-gray-600/50 transition-all">
                    ...
                    <span className="text-gray-300 font-semibold text-sm">Google</span>
                  </div>
                  ...
                  <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-lg border border-gray-700/30 hover:border-gray-600/50 transition-all">
                    ...
                    <span className="text-gray-300 font-semibold text-sm">Microsoft</span>
                  </div>

                  {/* Amazon */}
                  <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-lg border border-gray-700/30 hover:border-gray-600/50 transition-all">
                    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none">
                      <path d="M14.93 17.45c-3.02 2.23-7.4 3.41-11.17 3.41-5.28 0-10.04-1.95-13.63-5.2-.28-.25-.03-.59.31-.4 3.87 2.25 8.66 3.6 13.6 3.6 3.34 0 7.01-.69 10.39-2.12.51-.21.93.33.45.71h.05z" fill="#FF9900"/>
                      <path d="M16.35 15.78c-.39-.5-2.56-.23-3.54-.12-.3.04-.34-.22-.07-.41 1.73-1.22 4.57-.87 4.9-.46.33.41-.09 3.26-1.72 4.62-.25.21-.49.1-.38-.18.37-.92 1.19-2.99.81-3.45z" fill="#FF9900"/>
                      <path d="M14.74 3.42v-1.2c0-.18.13-.3.3-.3h5.39c.17 0 .3.13.3.3v1.03c0 .17-.14.39-.39.74l-2.79 3.98c1.04-.03 2.13.13 3.07.65.21.12.27.29.29.46v1.28c0 .17-.19.38-.39.27-1.63-.86-3.8-.95-5.61.01-.18.1-.37-.1-.37-.27v-1.21c0-.19 0-.52.2-.81l3.23-4.63h-2.82c-.17 0-.3-.13-.3-.3z" fill="currentColor" className="text-gray-300"/>
                    </svg>
                    <span className="text-gray-300 font-semibold text-sm">Amazon</span>
                  </div>

                  {/* Flipkart */}
                  <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-lg border border-gray-700/30 hover:border-gray-600/50 transition-all">
                    <div className="w-5 h-5 bg-gradient-to-br from-blue-500 to-yellow-400 rounded flex items-center justify-center">
                      <span className="text-white font-bold text-xs">F</span>
                    </div>
                    <span className="text-gray-300 font-semibold text-sm">Flipkart</span>
                  </div>

                  {/* PhonePe */}
                  <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-lg border border-gray-700/30 hover:border-gray-600/50 transition-all">
                    <div className="w-5 h-5 bg-gradient-to-br from-purple-600 to-purple-400 rounded flex items-center justify-center">
                      <span className="text-white font-bold text-xs">P</span>
                    </div>
                    <span className="text-gray-300 font-semibold text-sm">PhonePe</span>
                  </div>

                  {/* CRED */}
                  <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-lg border border-gray-700/30 hover:border-gray-600/50 transition-all">
                    <div className="w-5 h-5 bg-black rounded flex items-center justify-center border border-gray-600">
                      <span className="text-white font-bold text-xs">C</span>
                    </div>
                    <span className="text-gray-300 font-semibold text-sm">CRED</span>
                  </div>

                  {/* Zoho */}
                  <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-lg border border-gray-700/30 hover:border-gray-600/50 transition-all">
                    <div className="w-5 h-5 bg-gradient-to-br from-red-600 to-yellow-500 rounded flex items-center justify-center">
                      <span className="text-white font-bold text-xs">Z</span>
                    </div>
                    <span className="text-gray-300 font-semibold text-sm">Zoho</span>
                  </div>
                  ...
                  <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-lg border border-gray-700/30 hover:border-gray-600/50 transition-all">
                    ...
                    <span className="text-gray-300 font-semibold text-sm">Accenture</span>
                  </div>
                  ...
                  <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-lg border border-gray-700/30 hover:border-gray-600/50 transition-all">
                    ...
                    <span className="text-gray-300 font-semibold text-sm">TCS</span>
                  </div>

                  {/* Wipro */}
                  <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-lg border border-gray-700/30 hover:border-gray-600/50 transition-all">
                    <div className="w-5 h-5 bg-gradient-to-br from-orange-500 to-yellow-400 rounded flex items-center justify-center">
                      <span className="text-white font-bold text-xs">W</span>
                    </div>
                    <span className="text-gray-300 font-semibold text-sm">Wipro</span>
                  </div>
                  ...
                  <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-lg border border-gray-700/30 hover:border-gray-600/50 transition-all">
                    ...
                    <span className="text-gray-300 font-semibold text-sm">Infosys</span>
                  </div>
                </div>
              </div>
            </div>
