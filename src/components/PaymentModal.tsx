          ...
          <>
            ...
            <div className="p-6 text-center border-b border-gray-700/50">
              ...
              <div className="bg-gradient-to-r from-amber-500/10 to-orange-500/10 rounded-xl p-4 border border-amber-500/30 mb-4">
                ...
                <p className="text-amber-400 font-semibold">70% OFF - Limited Time</p>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex justify-center">
                ...
                <div className="bg-gray-700/30 rounded-xl p-6 text-center border border-gray-600/50 max-w-sm">
                  ...
                  <p className="text-xs text-gray-400">Pay ₹299 to Lahori Venkatesh</p>
                </div>
              </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4">
                ...
                <ol className="text-sm text-blue-200 space-y-2 list-decimal list-inside">
                  <li>Scan any QR code above and pay ₹299</li>
